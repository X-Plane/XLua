...
- [XPLMTextureAtlasAddImageSet](#xplmtextureatlasaddimageset)
...
RGBA format, 4 bytes per pixel, with rows ordered from top to bottom.
The atlas must not have been baked yet.
