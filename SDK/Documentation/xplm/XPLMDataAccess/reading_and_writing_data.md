...
- [XPLMShareData](sharing_data_between_multiple_plugins.md#xplmsharedata)
- [XPLMUnshareData](sharing_data_between_multiple_plugins.md#xplmunsharedata)
...
| name | const char * | The full name/path of the data ref |
| type | XPLMDataTypeID |  |
| writable | int | TRUE if the data ref permits writing to it. FALSE if it's read-only. |
