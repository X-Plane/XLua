...
<pre><code class="language-lua">local My_FontMetrics_t = {
    structSize   = 0,       -- int
    lineHeight   = 0.0,     -- float
    lineAscent   = 0.0,     -- float
    lineDescent  = 0.0,     -- float
}</code></pre>
</div>
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">local my_fontHandle = nil  -- XPLMFontHandle</code></pre>
</div>
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">-- returns XPLMFontHandle -> assign to local/var
local my_fontHandle = XPLMCreateFont(
    charset     -- see XPLMCharSet_t
)</code></pre>
</div>
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMDestroyFont(
    font     -- XPLMFontHandle
)</code></pre>
</div>
...
local my_result = XPLMFontAddFace(
    font,        -- XPLMFontHandle
    ttf_path     -- char const
)</code></pre>
</div>
...
local outs = XPLMFontGetMetrics(
    font,        -- XPLMFontHandle
    fontSize     -- float
)
-- outs = { outMetrics }</code></pre>
</div>
...
local my_result = XPLMFontMeasureString(
    font,        -- XPLMFontHandle
    fontSize,    -- float
    string       -- char const
)</code></pre>
...
local my_result = XPLMFontGetLineCount(
    font,        -- XPLMFontHandle
    fontSize,    -- float
    string,      -- char const
    width        -- float
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">-- returns int -> assign to local/var
local my_result = XPLMFontFitForward(
    font,        -- XPLMFontHandle
    fontSize,    -- float
    string,      -- char const
    width        -- float
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">-- returns int -> assign to local/var
local my_result = XPLMFontFitReverse(
    font,        -- XPLMFontHandle
    fontSize,    -- float
    string,      -- char const
    width        -- float
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMFontDrawString(
    font,             -- XPLMFontHandle
    ...
    y,                -- float
    string,           -- char const
    justification     -- see XPLMJustification_t
)</code></pre>
</div>
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMFontDrawStringFixedSpacing(
    font,             -- XPLMFontHandle
    color,            -- see uint32_t / XPLMMakeColor
    fontSize,         -- float
    x,                -- float
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMFontDrawStringWordWrapped(
    font,             -- XPLMFontHandle
    color,            -- see uint32_t / XPLMMakeColor
    fontSize,         -- float
    x,                -- float
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMFontDrawStringRotated(
    font,             -- XPLMFontHandle
    color,            -- see uint32_t / XPLMMakeColor
    fontSize,         -- float
    x,                -- float
