...
<pre><code class="language-lua">local my_retainedDrawing_t = nil  -- XPLMRetainedDrawing_t</code></pre>
</div>
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMBeginRetainedDrawing(
)</code></pre>
</div>
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">-- returns see XPLMRetainedDrawing_t -> assign to local/var
...
<div class="lua-code" markdown="1">
<pre><code class="language-lua">XPLMDrawRetained(
